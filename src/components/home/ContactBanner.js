    ...
    <section className="py-40 bg-transparent relative overflow-hidden group">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 flex justify-center">
        <motion.div 
           ...
           className="glass-frosted w-full max-w-6xl p-16 md:p-32 rounded-[5rem] border-primary/5 flex flex-col items-center text-center relative overflow-hidden shadow-[0_0_150px_-30px_rgba(251,191,36,0.1)]"
        >
           ...
           <motion.h2 
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
              className="text-fluid-md font-black tracking-tighter text-primary uppercase leading-[0.85] mb-12 max-w-4xl"
           >
           ...
           <motion.p 
              ...
              className="text-primary/60 text-lg md:text-xl font-black uppercase tracking-[0.4em] mb-16 max-w-2xl leading-relaxed"
           >
           ...
           >
              ...
              <div className="flex flex-col items-center md:items-start space-y-3">
                 <Link href={`tel:+91${settings?.phone?.replace(/\s+/g, '')}`} className="flex items-center space-x-6 text-primary hover:text-accent transition-colors group/phone font-black tracking-tighter text-3xl">
